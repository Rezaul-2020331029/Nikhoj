package reza.monolithicbackend.Auth.config;
...
import reza.monolithicbackend.Auth.security.RestAuthenticationEntryPoint;
import reza.monolithicbackend.Auth.security.filtter.JwtAuthenticationFilter;
import reza.monolithicbackend.Auth.security.handler.CustomAccessDeniedHandler;
import reza.monolithicbackend.Auth.security.handler.OAuth2LoginSuccessHandler;
import reza.monolithicbackend.Auth.security.oauth2.HttpCookieOAuth2AutherizationRequestRepository;
import reza.monolithicbackend.Auth.service.JwtTokenService;
import reza.monolithicbackend.Auth.service.OAuthUserService;
import reza.monolithicbackend.Auth.service.RoleService;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(authorizeRequests ->
                        authorizeRequests.
                                requestMatchers("/api/auth/**", "/error","/api/guest/**").permitAll()
